const {
 ...
 smd({
   ...
   try {
     ...
     try {
       ...
       _0x160b96.reply("*_✅Group description Updated Successfuly! by king Phantom 👑_*");
     } catch (_0x986809) {
 ...
 smd({
   ...
   try {
     ...
     if (_0x6118c5.startsWith("sure") || _0x6118c5.startsWith("ok") || _0x6118c5.startsWith("yes")) {
       ...
       _0x37841c.send("*BOW BEFORE THE KING 👑!!*", {}, "", _0x37841c, _0x37841c.user);
     } else {
 ...
 smd({
   ...
   try {
     ...
     if (!_0xc0618e || !mtypes.includes(_0xc0618e?.mtype || "need_Media")) {
       return await _0x5ac912.reply("*Reply to an image, bruhh*");
     }
 ...
 cmd({
   ...
   try {
     ...
     return _0x53f8e3.reply("*Group Invite Link Is Here, | powered by Phantom |i* \n*" + _0x41db31 + "*");
   } catch (_0x4e30e8) {
 ...
 cmd({
   ...
   try {
     ...
     if (!_0x1d2bb7) {
       return await _0x19564c.reply("*Provide Me Country Code. Example: .kik 27*");
     }
 ...
 cmd({
   ...
   try {
     ...
     if (!_0x2ee3cb) {
       return await _0x4bd51e.reply("*Provide Me Country Code. Example: .num 27*");
     }
